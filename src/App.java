...
public class App {
    ...
    private static void basicDemos() {
         ...
         * Museum firstMuseum = em.find(Museum.class, 4); // parameter 2: the primary
         * key value.
         * if (firstMuseum != null) {`
         ...
         * // Otherwise we'll keep trying to create an object with a non-unique primary
         * key,
         ...
         * System.out.println("Museum " + newMuseum +
         * " added to database. Go check DataGrip if you don't believe me!");
         * 
         * // Example 3: updating an entity.
         * Museum fromDatabase = em.find(Museum.class, 4);
         * em.getTransaction().begin();
         * fromDatabase.setLocation("Manhattan, New York, NY");
         * // This object is already staged, since it was retrieved from the
         * EntityManager.
         ...
         * 
         * // Suppose we want to find "Museum of Latin American Art". We'd write this
         * query:
         * // SELECT * FROM MUSEUMS WHERE NAME = 'Museum of Latin American Art'
         * 
         * // JPA doesn't use SQL; it uses JPQL, which doesn't select from arbitrary
         * tables,
         ...
         * // MUSEUMS table one row at a time, temporarily calling each row "m". We can
         * then
         * // refer to "m" like it's an object, in order to select a row or filter based
         * // on its columns.
         * 
         * // createQuery returns a Query object, which can be executed with
         * getSingleResult
         ...
         * var museums = em.createQuery("select m from museums m",
         * Museum.class).getResultList();
         * 
         ...
         * Persistence.createEntityManagerFactory("museumDb");
         * EntityManager em = factory.createEntityManager();
         * 
         * 
         * 
         ...
         * // Museum has a superintendent field that we can access to follow the
         * association:
         * System.out.println("MOLAA's Superintendent: " + molaa.getSuperintendent());
         * 
         * Superintendent sup = em.find(Superintendent.class, 1);
         * //System.out.println("Superindendent #1: " + sup + " works at museum " +
         * sup.getMuseum());
         * 
         ...
         * // JPQL lets us navigate between objects using "." notation like accessing
         * fields.
         ...
         * 
         * System.out.println();
         * // In a bidirectional association, we can also walk from the Many to the
         * One...
         * Building bu = em.find(Building.class, 1);
         * System.out.println(bu + " is in Museum " + bu.getMuseum());
         * 
         * // ... or even find the Many objects based on the One they are associated
         * with.
